...
<head>
    ...
    <link rel="stylesheet" id="main-css" href="${theme_base!}/source/css/main.css" type="text/css" media="all">
    ...
    <script type="text/javascript" src="${theme_base!}/source/js/wcool.js" id="wcool-js"></script>
    <@global.head />
</head>
</#macro>